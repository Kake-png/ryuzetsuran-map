...
const rules = [
  ...
  },
  {
    icon: ShieldCheck,
    title: "公道などから確認して投稿",
    text: "公道・公園など公開された場所、来訪を受け入れる施設、またはそれらから確認できる私有地の株を投稿できます。私有地内には立ち入りません。",
  },
  {
    icon: Eye,
    title: "投稿内容は申告として扱う",
    text: "運営が一件ずつ掲載許可や投稿内容を事前確認したとは表示しません。場所の区分と投稿者の関係を保存し、申告に基づく情報だと明確に扱います。",
  },
  {
    icon: Siren,
    title: "問題があれば、ピン全体を止める",
    text: "私有地・生活への影響や安全に関する申告を受けた場合は、その場でピンを一時非公開にします。再公開の根拠を確認できない場合は、非公開を継続することがあります。",
  },
  {
    icon: KeyRound,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="rules-dialog sm:max-w-2xl">
        ...
        <section className="disclaimer-section" aria-labelledby="disclaimer-heading">
          ...
          <p>この地図の利用や現地での行動により生じた事故・損害・近隣トラブルについて、運営は法令上認められる範囲で責任を負いません。問題のある掲載は、申告に応じて一時非公開または掲載終了とする場合があります。</p>
        </section>
      </DialogContent>
    </Dialog>
  );
