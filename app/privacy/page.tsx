  ...
  return (
    <main className="legal-shell">
      ...
      <article className="legal-page">
        ...
        <section><h2>外部サービス</h2><p>このサイトは、配信・データベース・写真保管にCloudflareを利用します。地図表示と市区町村の補完では外部の地図サービスを利用し、アクセス傾向の把握にCloudflare Web Analyticsを利用します。植物・育成用品のページでは楽天アフィリエイトの商品画像を表示し、応援ページからはOFUSEへ移動できます。これらの表示や利用に必要な範囲で、通信情報が各提供者に送信される場合があります。</p></section>
